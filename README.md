...
<body>
    <div class="jumbotron jumbotron-fluid" style="background-color:rgba(25, 219, 233, 0.548);">
    ...
    <div class="container">
        <form action="/HouseModelTraining/" method="POST">
            ...
            <div class="form-group row">
                <label for="samples" class="col-md-2 col-form-label" style="background-color:rgba(25, 219, 233, 0.363);">Total Samples</label>
                <div class="col-md-10">
            ...
            <div class="form-group row">
                <label for="score" class="col-md-2 col-form-label" style="background-color:rgba(25, 219, 233, 0.363);">Score</label>
                <div class="col-md-10">
...
<html lang="en">
  ...
  <body>
        ...
        <div class="jumbotron jumbotron-fluid" style="background-color:rgb(40, 233, 82); ">
        ...
        <div class="container" >                      
            <form action="/HouseModelPrediction/" method="POST">
                {% csrf_token %}
            <div class="form-group row">
                <label for="area" class="col-md-2 col-form-label" style="background-color:rgba(40, 233, 82, 0.479); ">Total Area</label>
                <div class="col-md-10">
                <input type="text" class="form-control" id="area" name="area" placeholder="1500"  value="{{area}}">
                </div>
            </div>            
            <div class="form-group row">
                <label for="bathrooms" class="col-md-2 col-form-label" style="background-color:rgba(40, 233, 82, 0.479); ">Bath Rooms</label>
                <div class="col-md-10">
                <input type="text" class="form-control" id="bathrooms" name="bathrooms" placeholder="2" value="{{bathrooms}}"> 
                </div>
            </div>       
            <div class="form-group row">
                <label for="bhk" class="col-md-2 col-form-label" style="background-color:rgba(40, 233, 82, 0.479); ">Bedroom Hall Kitchen</label>
                <div class="col-md-10">
                <input type="text" class="form-control" id="bhk" name="bhk" placeholder="3" value="{{bhk}}">
                </div>
            </div>      
            <div class="form-group row">
                <label for="location" class="col-md-2 col-form-label" style="background-color:rgba(40, 233, 82, 0.479); ">Location</label>
                <div class="col-md-10">
            ...
            <div class="form-group row">
                <label for="price" class="col-md-2 col-form-label" style="background-color:rgba(40, 233, 82, 0.479); " >Price(Lakh)</label>
                <div class="col-md-10">
...
![output](./static/img/va1.png)
![output](./static/img/va2.png)

## RESULT:
    Thus a website is designed to train the house price model and to predict the price.And is hosted in the URLs http://gowri.student.saveetha.in:8000/HouseModelTraining/, http://gowri.student.saveetha.in:8000/HouseModelPrediction/.HTML code is validated.